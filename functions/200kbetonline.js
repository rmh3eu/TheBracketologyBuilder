...
<head>
  ...
  <meta name="description" content="On BetOnline. Get $250 in bonus with sign up.">
  <meta property="og:title" content="Get $250 in Bonus with Sign Up">
  <meta property="og:description" content="On BetOnline. Get $250 in bonus with sign up.">
  ...
  <meta name="twitter:description" content="On BetOnline. Get $250 in bonus with sign up.">
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      color:var(--white);
      background:
        radial-gradient(circle at 75% 25%, rgba(239,45,45,.16), transparent 26%),
        linear-gradient(180deg, #08080c 0%, #11131a 100%);
    }
    .wrap{
      min-height:100vh;
      display:flex;
    ...
    .brand .bet{color:var(--red)}
    .brand .online{color:var(--white)}
    h1{
      margin:0 0 14px;
...
<body>
  <div class="wrap">
    <div class="card">
      <div class="brand"><span class="bet">BET</span><span class="online">ONLINE</span></div>
      <h1>Redirecting to <span class="money">BetOnline</span><br>Get $250 in Bonus with Sign Up</h1>
      <p>Taking you to BetOnline now. Get $250 in bonus with sign up.</p>
      <div class="spinnerRow">
        <div class="spinner" aria-hidden="true"></div>
        <div>Redirecting automatically…</div>
      </div>
