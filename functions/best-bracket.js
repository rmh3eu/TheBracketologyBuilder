export async function onRequest({ request }) {
  const targetUrl = "https://bracketologybuilder.com/best-challenge";
  const shareUrl = "https://bracketologybuilder.com/best-bracket";
  const url = new URL(request.url);
  const ogImage = `${url.origin}/images/best-bracket-preview.png`;
...
<head>
  ...
  <meta name="description" content="Try our Best Bracket Challenge on BracketologyBuilder.">
...
<body>
  <div class="card">
    ...
    <div class="headline">🏀 Try Our <span class="accent">Best Bracket</span> Challenge</div>
    <p>Are you usually leading after the first weekend? Try creating a bracket where every game is worth the same.</p>
    <div class="actions">
      <a class="btn" href="${targetUrl}">Try the Best Challenge</a>
