export async function onRequest({ request }) {
  ...
  const shareUrl = `${url.origin}/worst`;
  const ogImage = `${url.origin}/images/worst-social-preview.png`;
  const html = `<!doctype html>
<html lang="en"><head>
<meta charset="utf-8">
<title>😈 Enter Our Worst Bracket Challenge</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Try to create the worst bracket possible.">
<meta property="og:title" content="😈 Enter Our Worst Bracket Challenge">
<meta property="og:description" content="Try to create the worst bracket possible and enter our Worst Bracket Challenge.">
...
<meta name="twitter:description" content="Try to create the worst bracket possible and enter our Worst Bracket Challenge.">
...
<h1>😈 Try to Build the <span class="gold">Worst Bracket</span> Possible</h1>
<p>Try to create the worst bracket possible and enter our Worst Bracket Challenge.</p>
<div class="actions">
<a class="btn" href="${siteUrl}">Enter Now</a>
<div class="sub">Share this link with friends: bracketologybuilder.com/worst</div>
